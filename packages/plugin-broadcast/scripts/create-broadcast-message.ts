...
[BROADCAST_REQUEST:${broadcastId}]`;
                ...
                const messageId = await saveMessageToMemories({
                    type: 'messages',
                    content: finalText
                });
                await recordBroadcast(document.id, {
                    telegramId: client === 'telegram' ? messageId : undefined,
                    twitterId: client === 'twitter' ? messageId : undefined
                });
