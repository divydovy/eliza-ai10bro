...
console.log('🧠 Using LLM to extract clean article content...\n');

// Get low-scoring documents that are likely polluted
...
for (const doc of docs) {
    console.log(`Processing ${doc.id.substring(0, 8)}...`);
...
console.log('\n⚠️  Run calculate-alignment-scores.js to recalculate scores');
